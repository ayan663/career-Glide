...
import data from '../Artificial Intelligence and Machine Learning.json'; // make sure path is correct

const appdev = () => {
  return (
    <div className="max-w-4xl mx-auto p-6">
      <h1 className="text-3xl font-bold text-center mb-6">artificial</h1>
